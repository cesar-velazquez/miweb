...
const About = () => {
  return (
    ...
    dark:bg-[url(/imgs/fondo/bgdesktop.png)] dark:bg-purple-bg dark:text-white
    sm:bg-[url(/imgs/fondo/EllipseMiddle.png)] sm:bg-right  sm:h-[100vh] sm:flex ' >
      ...
      <div className='flex flex-col gap-4 md:grid md:grid-cols-2 md:px-4 md:py-6  max-w-[1200px] m-auto '>
        ...
        <div className='flex flex-col justify-center items-center'>
          <h1 className='font-urbanist px-2 text-center md:text-3xl  ' >Hola.! mucho gusto, mi nombre es <span className='border border-b-blue-800 border-none' > César Velazquez.</span></h1>
